...
from entries b join params pm
               join entries e on e.id = b.parent_id
							               and e.deleted_at is null
							               and e.type = 'episode'
where cast(b.dates->>'$.start' as datetime) >= pm.bc_start
	and b.deleted_at is null
	and b.type = 'broadcast'
	and b.site_id = pm.tgt_site_id
), ds2 as (
select ep_id, min(cast(b.dates->>'$.start' as datetime)) as first_bc
from ds1 join params pm
